...
describe('StackForm', () => {
    ...
    it('renders a button to save the form', () => {
        expect(stackForm.find('Button').at(1).props().children).toEqual('Save Stack');
    });

    describe('and updating the tittle', () => {
        beforeEach(() => {
    ...
    describe('when adding a new card', () => {
        ...
        describe('and updating the card prompt', () => {
            ...
            it('updates th prompt in the state', () => {
    ...
    // describe('when saving a new stack', () => {
    //     beforeEach(() => {
    //         stackForm.find('Button').at(1).simulate('click');
    //     });

    //     it('adds it to ather cards', ()=>{
